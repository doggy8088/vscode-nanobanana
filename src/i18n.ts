...
const EN_MESSAGES: Record<string, string> = {
  ...
  'panel.imageEditor.promptLabel': 'Prompt',
  'panel.imageEditor.promptPlaceholder': 'Describe how to edit this image.',
  'panel.imageEditor.annotationTextLabel': 'Annotation Text',
  'panel.imageEditor.annotationTextPlaceholder': 'Type text and click image to place.',
...
const MESSAGES: Record<SupportedLocale, Record<string, string>> = {
  ...
  'zh-TW': {
    ...
    'panel.imageEditor.tool.ellipse': '圓形',
    'panel.imageEditor.tool.text': '文字',
    'panel.imageEditor.action.undo': '復原',
    'panel.imageEditor.action.clear': '清除',
    'panel.imageEditor.action.generate': '開始改圖',
    'panel.imageEditor.promptLabel': '提示詞',
    'panel.imageEditor.promptPlaceholder': '請描述要如何修改這張圖片。',
    'panel.imageEditor.annotationTextLabel': '標註文字',
    'panel.imageEditor.annotationTextPlaceholder': '輸入文字後點擊圖片放置。',
  ...
  'zh-CN': {
    ...
    'panel.imageEditor.promptLabel': '提示词',
    'panel.imageEditor.promptPlaceholder': '请描述要如何修改这张图片。',
    'panel.imageEditor.annotationTextLabel': '标注文字',
    'panel.imageEditor.annotationTextPlaceholder': '输入文字后点击图片放置。',
