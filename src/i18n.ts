...
const EN_MESSAGES: Record<string, string> = {
  ...
  'input.finalDirectionPrompt': 'Optional: add one final direction to adjust image generation',
...
const MESSAGES: Record<SupportedLocale, Record<string, string>> = {
  ...
  'zh-TW': {
    ...
    'input.finalDirectionPrompt': '可選：輸入最後補充指令以微調生圖方向',
  ...
  'zh-CN': {
    ...
    'input.finalDirectionPrompt': '可选：输入最后补充指令以微调生图方向',
