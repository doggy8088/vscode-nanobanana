...
const EN_MESSAGES: Record<string, string> = {
  ...
  'input.finalDirectionPrompt':
    'Optional: enter a refinement instruction to edit the generated image',
  'input.optionalPlaceholder': 'Leave empty to skip',
  'input.freeformPrompt': 'Enter an image prompt',
  'input.editInstructionPrompt': 'Describe how to edit this image',
  ...
  'error.noImageTarget': 'No image target found. Open or select a .png/.jpg image and try again.',
  'error.unsupportedImageFile': 'Only .png, .jpg, and .jpeg images are supported for editing.',
  'error.editorPromptEmpty': 'Please enter an edit prompt before generating.',
  'error.editorAnnotationTextEmpty': 'Please enter annotation text.',
  ...
  'info.openApiKeySetup': 'Gemini API Key is required. Opening setup now...',
  'info.copilotPromptModelSaved': 'Copilot prompt model saved: {modelId}',
  'info.imageGenerated': 'Image generated: {path}',
  'progress.generating': 'Nano Banana is generating image...',
  'progress.editing': 'Nano Banana is editing image...',
  'quickpick.style.title': 'Choose image style',
  'quickpick.style.placeholder': 'Select a style preset',
  'quickpick.copilotModel.title': 'Choose Copilot prompt model',
  'quickpick.copilotModel.placeholder': 'Select from currently available Language Model API models',
  'quickpick.copilotModel.auto.label': 'Auto',
  'quickpick.copilotModel.auto.description': 'Use the first available model',
  'quickpick.aspectRatio.title': 'Choose aspect ratio',
  'quickpick.aspectRatio.placeholder': 'Select an aspect ratio',
  'quickpick.imageSize.title': 'Choose image size',
  'quickpick.imageSize.placeholder': 'Select image size for this generation',
  'quickpick.default': 'Default',
  'panel.imageEditor.title': 'Nano Banana Image Editor',
  'panel.imageEditor.pickImageTitle': 'Choose an image file to edit',
  'panel.imageEditor.tool.rect': 'Rect',
  'panel.imageEditor.tool.ellipse': 'Circle',
  'panel.imageEditor.tool.text': 'Text',
  'panel.imageEditor.action.undo': 'Undo',
  'panel.imageEditor.action.redo': 'Redo',
  'panel.imageEditor.action.clear': 'Clear',
  'panel.imageEditor.action.generate': 'Start Editing',
  'panel.imageEditor.promptLabel': 'Edit Suggestions',
  'panel.imageEditor.promptPlaceholder': 'Describe how to edit this image.',
  'panel.imageEditor.annotationTextPrompt': 'Enter annotation text.',
  'panel.imageEditor.imageSizeLabel': 'Image Size',
  'panel.imageEditor.status.ready': 'Ready',
  'panel.imageEditor.status.processing': 'Editing image...',
  ...
  'log.debugMode': 'Mode: {mode}',
  'log.debugParams': 'Style={style}, AspectRatio={aspectRatio}, ImageSize={imageSize}, ModelId={modelId}',
  'log.debugPromptStart': 'Prompt sent to Gemini >>>',
  'log.debugPromptEnd': '<<< End prompt',
...
const MESSAGES: Record<SupportedLocale, Record<string, string>> = {
  ...
  'zh-TW': {
    ...
    'input.finalDirectionPrompt': '可選：輸入改圖指示（將以前一步生成圖片作為參考）',
    'input.optionalPlaceholder': '留空可略過',
    'input.freeformPrompt': '請輸入要生成的圖片描述',
    'input.editInstructionPrompt': '請輸入改圖指示',
    ...
    'error.noImageTarget': '找不到目標圖片，請先開啟或選取 .png/.jpg 圖片再重試。',
    'error.unsupportedImageFile': '改圖僅支援 .png、.jpg、.jpeg。',
    'error.editorPromptEmpty': '請先輸入改圖提示詞。',
    'error.editorAnnotationTextEmpty': '請輸入標註文字。',
    ...
    'info.openApiKeySetup': '需要 Gemini API Key，現在開啟設定流程...',
    'info.copilotPromptModelSaved': 'Copilot 提示詞模型已儲存：{modelId}',
    'info.imageGenerated': '圖片已生成：{path}',
    'progress.generating': 'Nano Banana 正在生成圖片...',
    'progress.editing': 'Nano Banana 正在改圖...',
    'quickpick.style.title': '選擇圖片風格',
    'quickpick.style.placeholder': '請選擇生圖風格',
    'quickpick.copilotModel.title': '選擇 Copilot 提示詞模型',
    'quickpick.copilotModel.placeholder': '從目前 Language Model API 可用模型中選擇',
    'quickpick.copilotModel.auto.label': '自動',
    'quickpick.copilotModel.auto.description': '使用目前第一個可用模型',
    'quickpick.aspectRatio.title': '選擇圖片比例',
    'quickpick.aspectRatio.placeholder': '請選擇圖片比例',
    'quickpick.imageSize.title': '選擇圖片尺寸',
    'quickpick.imageSize.placeholder': '請選擇本次生圖尺寸',
    'quickpick.default': '預設',
    'panel.imageEditor.title': 'Nano Banana 圖片編輯器',
    'panel.imageEditor.pickImageTitle': '選擇要編輯的圖片',
    'panel.imageEditor.tool.rect': '矩形標注',
    'panel.imageEditor.tool.ellipse': '橢圓標注',
    'panel.imageEditor.tool.text': '文字標注',
    'panel.imageEditor.action.undo': '復原上次標注(Undo)',
    'panel.imageEditor.action.redo': '重新再次標注(Redo)',
    'panel.imageEditor.action.clear': '清除所有標注(Clear)',
    'panel.imageEditor.action.generate': '開始改圖',
    'panel.imageEditor.promptLabel': '圖片修正建議',
    'panel.imageEditor.promptPlaceholder': '請描述要如何修改這張圖片。',
    'panel.imageEditor.annotationTextPrompt': '請輸入要標註的文字。',
    'panel.imageEditor.imageSizeLabel': '圖片尺寸',
    'panel.imageEditor.status.ready': '就緒',
    'panel.imageEditor.status.processing': '正在改圖...',
    'log.debugSeparator': '================ 偵錯 ================',
    'log.debugMode': '模式：{mode}',
    'log.debugParams': '風格={style}，比例={aspectRatio}，尺寸={imageSize}，模型={modelId}',
    'log.debugPromptStart': '送到 Gemini 的提示詞 >>>',
    'log.debugPromptEnd': '<<< 提示詞結束',
  ...
  'zh-CN': {
    ...
    'input.finalDirectionPrompt': '可选：输入改图指示（会以上一步生成图片作为参考）',
    'input.optionalPlaceholder': '留空可跳过',
    'input.freeformPrompt': '请输入图片生成提示词',
    'input.editInstructionPrompt': '请输入改图指示',
    ...
    'error.noImageTarget': '未找到目标图片，请先打开或选择 .png/.jpg 图片后再试。',
    'error.unsupportedImageFile': '改图仅支持 .png、.jpg、.jpeg。',
    'error.editorPromptEmpty': '请先输入改图提示词。',
    'error.editorAnnotationTextEmpty': '请输入标注文字。',
    ...
    'info.openApiKeySetup': '需要 Gemini API Key，正在打开设置流程...',
    'info.copilotPromptModelSaved': 'Copilot 提示词模型已保存：{modelId}',
    'info.imageGenerated': '图片已生成：{path}',
    'progress.generating': 'Nano Banana 正在生成图片...',
    'progress.editing': 'Nano Banana 正在改图...',
    'quickpick.style.title': '选择图片风格',
    'quickpick.style.placeholder': '请选择生图风格',
    'quickpick.copilotModel.title': '选择 Copilot 提示词模型',
    'quickpick.copilotModel.placeholder': '从当前 Language Model API 可用模型中选择',
    'quickpick.copilotModel.auto.label': '自动',
    'quickpick.copilotModel.auto.description': '使用当前第一个可用模型',
    'quickpick.aspectRatio.title': '选择图片比例',
    'quickpick.aspectRatio.placeholder': '请选择图片比例',
    'quickpick.imageSize.title': '选择图片尺寸',
    'quickpick.imageSize.placeholder': '请选择本次生图尺寸',
    'quickpick.default': '默认',
    'panel.imageEditor.title': 'Nano Banana 图片编辑器',
    'panel.imageEditor.pickImageTitle': '选择要编辑的图片',
    'panel.imageEditor.tool.rect': '方形',
    'panel.imageEditor.tool.ellipse': '圆形',
    'panel.imageEditor.tool.text': '文字',
    'panel.imageEditor.action.undo': '撤销',
    'panel.imageEditor.action.redo': '重做',
    'panel.imageEditor.action.clear': '清除',
    'panel.imageEditor.action.generate': '开始改图',
    'panel.imageEditor.promptLabel': '图片修正建议',
    'panel.imageEditor.promptPlaceholder': '请描述要如何修改这张图片。',
    'panel.imageEditor.annotationTextPrompt': '请输入要标注的文字。',
    'panel.imageEditor.imageSizeLabel': '图片尺寸',
    'panel.imageEditor.status.ready': '就绪',
    'panel.imageEditor.status.processing': '正在改图...',
    'log.debugSeparator': '================ 调试 ================',
    'log.debugMode': '模式：{mode}',
    'log.debugParams': '风格={style}，比例={aspectRatio}，尺寸={imageSize}，模型={modelId}',
    'log.debugPromptStart': '发送到 Gemini 的提示词 >>>',
    'log.debugPromptEnd': '<<< 提示词结束',
